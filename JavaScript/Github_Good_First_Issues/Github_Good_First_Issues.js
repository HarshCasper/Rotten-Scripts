...
const init = () => {
     ...
     * c. Scrapping from the repos that we/or someone else has starred
     * 
     * 2. fetch repos
    ...
    */
    ...
    console.log("3. From the starred repos of an user (enter 3)")
    let method = prompt("Choose method to fetch repos : ")
    ...
    let repos = getRepos(method, username)
    let issues = getIssues(repos)
