...
def main():
    ...
    parser_register = subparser.add_parser(
        'register', help="Register your credentials")
    # Register Sender's Email id
    parser_register.add_argument(
        '-id', type=str, help="Enter sender's email id")
    # Register Sender's Email password
    parser_register.add_argument(
        '-pwd', type=str, help="Enter sender's email password")
    ...
    parser_send.add_argument(
        '-text', type=str, help="Render text files as templates")
    # Path to Email reciever's list from CSV
    parser_send.add_argument(
        '-path', type=str, help="Path to CSV file containing list of reciever's email ids")
