...
my_parser.add_argument('--artist', action='store', type=str,
                       required=True, help="Enter the name of the artist/ band")
my_parser.add_argument('--song', action='store', type=str,
                       required=True, help="Enter the name of the song")
