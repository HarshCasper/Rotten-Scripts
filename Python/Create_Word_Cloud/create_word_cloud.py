...
my_parser.add_argument('--mask', action='store', type=str,
                       required=False, help="Enter the path to a mask of your choice")
my_parser.add_argument('--contour_width', action='store', type=int,
                       required=False, help="Enter the width of the contour you prefer")
my_parser.add_argument('--contour_color', action='store', type=str,
                       required=False, help="Enter the color of the contour you prefer")
my_parser.add_argument('--color_func', action='store', type=bool,
                       required=False, help="Do you want the color of the mask intact?")
...
createWordCloud(text, background_color, mask,
                contour_width, contour_color, color_func)
