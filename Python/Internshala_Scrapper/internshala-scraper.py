...
with open('internshala.csv', mode='a') as f:
    ...
    writer.writerow(['Company', 'Profile', 'Location/s',
                     'From', 'Upto', 'Duration', 'Stipend', 'Link'])
    for i in range(1, pages+1):
        ...
        for x in range(0, len(companies)):
            ...
            info.append(extracted[1].replace(
                'immediatelyImmediately', 'Immediately'))
