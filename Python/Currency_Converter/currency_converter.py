...
my_parser.add_argument('--amount', action='store', type=int,
                       required=True, help="Enter the amount")
my_parser.add_argument('--f', action='store', type=str,
                       required=True, help="Convert from")
