...
my_parser.add_argument('--location', action='store', type=str, required=False, help="Enter the location")
my_parser.add_argument('--country', action='store', type=str, required=False, help="Enter the country code")
